...
void x264Decoder::initialize(int w = 640, int h = 480)
{
    ...
    convert_context_ = sws_getContext(image_w_, image_h_, AV_PIX_FMT_YUV420P, image_w_, image_h_, AV_PIX_FMT_BGR24, SWS_FAST_BILINEAR, NULL, NULL, NULL);
...
bool x264Decoder::decodeFrame(char *src_buffer, unsigned int size, char *rgb_buffer)
{
    ...
    avpicture_layout((AVPicture *)av_frame_RGB_, AV_PIX_FMT_BGR24, image_w_, image_h_, (unsigned char *)rgb_buffer, rgb_size_);
